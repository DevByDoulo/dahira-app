...
const PERMISSIONS = {
  ...
  'presences.view':   [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],
  'presences.create': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'presences.update': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'presences.delete': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],

  'recus.generate':  [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'recus.send':      [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'recus.view_own':  [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],

  'notifications.view_own':      [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],
  'notifications.send_all':      [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT],
  'notifications.send_reminders':[ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],

  'annonces.view':   [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],
  'annonces.create': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT],
  'annonces.update': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT],
  'annonces.delete': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT],

  'evenements.view':     [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],
  'evenements.create':   [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'evenements.update':   [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER],
  'evenements.delete':   [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT],
  'evenements.register': [ROLES.SECRETAIRE_GENERAL, ROLES.ADJOINT, ROLES.TRESORIER, ROLES.MEMBRE],
